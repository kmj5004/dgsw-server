...
begin
    uut: entity work.mux2 port map(a => a, b => b, sel => sel, y => y);
    process
    begin
        a <= '0'; b <= '1'; sel <= '0'; wait for 1 ns; print_vec(1, y);
        a <= '0'; b <= '1'; sel <= '1'; wait for 1 ns; print_vec(2, y);
        a <= '1'; b <= '0'; sel <= '0'; wait for 1 ns; print_vec(3, y);
        a <= '1'; b <= '0'; sel <= '1'; wait for 1 ns; print_vec(4, y);
        wait;
    end process;
end architecture;
